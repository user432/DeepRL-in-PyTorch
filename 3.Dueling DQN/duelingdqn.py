...
class DuelingDQN(nn.Module):
    def __init__(self, ALPHA, n_actions, name, input_dims, chkpt_dir='tmp/dueldqn'):
...
class Agent(object):
    def __init__(self, gamma, epsilon, alpha, n_actions, input_dims,
        ...
        self.q_eval = DuelingDQN(alpha, n_actions, input_dims=input_dims,
                                   name='q_eval', chkpt_dir=chkpt_dir)
        self.q_next = DuelingDQN(alpha, n_actions, input_dims=input_dims,
